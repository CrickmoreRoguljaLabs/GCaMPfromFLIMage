# GCaMP-from-Flimage
GCaMP Analysis from FLIMage Software. Depends on the padcat function. Please use the latest version (V7), older versions may contain bugs and are only compatible with windows.
